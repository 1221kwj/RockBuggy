...
namespace RGSK
{
    public class WaypointCircuit : MonoBehaviour
    {
		...
		public PathCreator.RaceMode raceMode = PathCreator.RaceMode.OneWay;
        ...
        [Range(100, 500)] public float pathSmoothness = 500;
        ...
        public Vector3 GetRoutePosition(float dist)
        {
			...
			switch (RaceMode)
			{
				...
				case PathCreator.RaceMode.OneWay:
				{
					...
					if (point < 2)
					{
						p0n = 0; p1n = 1; p2n = 2; p3n = 3;
					}
					else if (point > numPoints - 2)
					{
						p0n = numPoints - 2;
						p1n = numPoints - 1;
						p2n = numPoints - 0;
					...
					if (p0n == numPoints - 1) p0n = 0;

					p3n = (point + 1) % numPoints;

					if (p3n == 0) p3n = numPoints - 1;
        ...
        private void DrawGizmos(bool selected)
        {
            ...
            if (Waypoints.Length > 1 && selected)
            {
                ...
                //Gizmos.DrawLine(prev, Waypoints[Waypoints.Length - 2].position);
            }
        }
