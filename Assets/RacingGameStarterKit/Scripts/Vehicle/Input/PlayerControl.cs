...
namespace RGSK
{
    public class PlayerControl : MonoBehaviour
    {
        ...
        public InputTypes inputType = InputTypes.Mobile;
        ...
        void MobileControl()
        {
            ...
            else
            {
                ...
                steer = GyroDevice.Get().eulerAngles.z;

                if (steer > 270.0f)
                    steer = steer - 360.0f;

                steer = -steer * 3.141592f / 180.0f;
            }
        ...
        {
            if (RaceManager.instance)
                RaceManager.instance.RespawnRacer(transform, GetComponent<Statistics>().lastPassedNode, 0.1f);
        }
    }
}
