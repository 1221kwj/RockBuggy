...
namespace RGSK
{
    public class MenuManager : MonoBehaviour
    {
        ...
        public Toggle mobileTouchSteer, mobileGyroSteer, mobileAutoAcceleration;
        ...
        void UpdateUI()
        {
            ...
            switch (state)
            {
                ...
                case State.TrackSelect:
                    ...
                    if (lapCount)
                    {
                        if (menuTracks[trackIndex].raceType == RaceManager.RaceType.FuelLimit
        ...
        public void ToggleGyroControl(bool b)
        {
