...
namespace NWH.VehiclePhysics
{
    ...
    public partial class VehicleController : MonoBehaviour
    {
        ...
        private void Initialize()
        {
			...
			switch (RaceManager.instance.raceTime)
			{
				case RaceManager.RaceTime.Day: input.fullBeamLights = false; break;
				case RaceManager.RaceTime.Night: input.fullBeamLights = true; break;
			}
        ...
        private void OnTriggerEnter(Collider other)
        {
            ...
            {
                float speed = other.gameObject.GetComponent<BoosterItem>().boosterSpeed;

                vehicleRigidbody.velocity += transform.forward.normalized * speed;
            }
        }
    }
}